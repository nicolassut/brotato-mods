...
FOODS = [
 ...
 food("espresso", "Espresso", "EFFECT_FOOD_ESPRESSO",
      buff=[("stat_attack_speed", 10, 0.2)], dur=10, stack_cap=8),
 ...
 food("fries", "Fries", "EFFECT_FOOD_FRIES",
      buff=[("stat_speed", 4, 0.1)], dur=9, stack_cap=10),
 ...
 food("pizza_slice", "Pizza Slice", "EFFECT_FOOD_PIZZA_SLICE",
      buff=[("stat_percent_damage", 3, 0), ("stat_speed", 3, 0)], dur=16, dur_app=0.15, stack_cap=10),
...
CSV_ROWS = [
 ...
 ("EFFECT_FOOD_ESPRESSO", "Eating an Espresso grants +{0}% ({1}) Attack Speed for 10 seconds. Stacks"),
 ...
 ("EFFECT_WOK_STATION", "Serves {0}x Fried Rice at the wok every 8 enemies that die burning"),
 ...
 ("EFFECT_SUSHI_BAR", "Spawns {0}x Sushi Roll every 12 critical hits"),
 ...
 ("EFFECT_STREET_VENDOR", "Mystery Meat shows up 1 to 3 times per wave ({0}x each), +0.3 per Appetite to both bounds (rounded)"),
 ...
 ("EFFECT_GYM_MEMBERSHIP", "Spawns {0}x Protein Shake every 200 steps"),
 ...
 ("EFFECT_AFTER_DINNER_MINTS", "Spawns {0}x Mint every 5 consumables you pick up"),
 ("EFFECT_FOOD_MINT", "Eating a Mint refreshes all your active food buffs to their full duration"),
 ("GOURMET_APPETITE_GAINED", "Appetite gained: {0}"),
 ("EFFECT_CHILI_GREENHOUSE", "Grows {0}x Chili Pepper at the greenhouse every 10 burning ticks you deal"),
 ...
 ("EFFECT_DOGGY_BAG", "Food that expires uneaten banks a Leftover. Every banked Leftover is served somewhere on the map next wave. The bank never resets"),
