#!/usr/bin/env python3
import sys
sys.exit("patch_item_service.py is a DEAD legacy one-shot from before the pack "
         "ecosystem. Registration lives in packs/<id>/pack_data.tres via "
         "asset-dev/pack_registry.py - see ECOSYSTEM.md. Refusing to run.")

# ---- original (disabled) below ----
# import re
# 
