...
/* ---------- detail ---------- */
.ov{position:fixed;inset:0;z-index:90;background:#000a;opacity:0;pointer-events:none;transition:opacity .15s}
.ov.on{opacity:1;pointer-events:auto}
.det{position:fixed;top:0;right:0;z-index:100;height:100vh;width:min(430px,94vw);background:var(--panel);
