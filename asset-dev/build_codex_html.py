...
HTML = r"""<title>Brotato: Gourmet Codex</title>
<style>
:root{
...
@media (max-width:760px){
  .app{display:block}
  .rail{position:sticky;top:0;z-index:20;width:auto;height:auto;border-right:none;border-bottom:3px solid #1d1a16;
    display:flex;gap:10px;flex-wrap:wrap;align-items:center;padding:10px 12px}
  .navgrp{margin:0;display:flex;gap:6px;align-items:center;flex-wrap:wrap}
  #navSources,#navClasses{flex-direction:row!important;flex-wrap:wrap}
  .navh{display:none}.logo{font-size:15px}.sub{display:none}
  .navbtn{padding:6px 10px}.navbtn .n{display:none}
  ...
  .det{width:100vw;max-width:100vw;left:0;right:0;border-radius:0}
}
</style>
