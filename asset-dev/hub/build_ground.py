...
# CLIFF band 2752x384: darker base + wobbly torn TOP LIP + base shadow
cliff = Image.new("RGBA", (2752, 384), (16, 13, 11, 255))
cd = ImageDraw.Draw(cliff)
cd.rectangle([0, 0, 2752, 384], fill=(20, 16, 14, 255))
for t in range(6):
    wobble_edge(cd, 0, 2752, 10 + t * 3, 8, (48, 42, 38, 255), 6, seed=70 + t)
wobble_edge(cd, 0, 2752, 6, 10, (58, 52, 46, 255), 8, seed=99)
cd.rectangle([0, 368, 2752, 384], fill=(10, 8, 7, 255))
wobble_edge(cd, 0, 2752, 366, 6, (10, 8, 7, 255), 10, seed=140)
n4 = scatter(cliff, rocks, 22, (0.34, 0.33, 0.34), margin=40, scale=0.9)
cliff.save(OUT1 + "ground_cliff.png"); cliff.save(OUT2 + "ground_cliff.png")
print("cliff band built, plates:", n4)
